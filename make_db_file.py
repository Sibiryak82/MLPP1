...
собственный формат записи; предполагается, что в данных отсутвуют строки
'endrec', 'enddb.' и '=>'; предполагатеся, что база данных явяляется словарем
...
реализовать сохрание словарей-записей целиком; кроме того, вместо вызова
